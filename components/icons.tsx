...
export const SparkleIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-15l4 4m6 6l4 4m-4-10l-4 4m-2 2l-4 4" />
  </svg>
);

export const BrainIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428A2 2 0 0018 14H6a2 2 0 00-1.428 1.428L3 21h18l-1.572-5.572z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14c0-3.866 2.686-7-6-7s6 3.134 6 7c0 3.866-2.686 7-6 7h-1a1 1 0 01-1-1v-5a1 1 0 011-1h1zm0 0c0-3.866-2.686-7-6-7s-6 3.134-6 7c0 3.866 2.686 7 6 7h1a1 1 0 001-1v-5a1 1 0 00-1-1H6z" />
  </svg>
);

export const TrophyIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 11l3-3m0 0l3 3m-3-3v8m0-13a9 9 0 110 18 9 9 0 010-18zm0 18v-3m0-12V3" />
